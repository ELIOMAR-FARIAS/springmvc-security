/*
 * package com.edigital.springmvcsecurity.config;
 * 
 ...
 * 
 * import com.edigital.springmvcsecurity.service.ImplUserDetailsService;
 * 
 * //import com.edigital.springmvcsecurity.security.JWTAuthenticationFilter;
 * //import com.edigital.springmvcsecurity.security.JWTAuthorizationFilter;
 * //import com.edigital.springmvcsecurity.security.JWTUtil;
 * 
 * @Configuration
 * 
 * @EnableWebSecurity
 ...
 * 
 * @Autowired private ImplUserDetailsService userDetailsService;
 * 
 ...
 * 
 * http.cors().and().csrf().disable(); http.authorizeRequests()
 * .antMatchers(HttpMethod.POST, PUBLIC_MATCHERS_POST).permitAll()
 * .antMatchers(HttpMethod.GET, PUBLIC_MATCHERS_GET).permitAll()
 * .antMatchers(PUBLIC_MATCHERS).permitAll() .anyRequest().authenticated();
 * 
 * // http.addFilter(new JWTAuthenticationFilter(authenticationManager(),
 * jwtUtil)); // http.addFilter(new
 * JWTAuthorizationFilter(authenticationManager(), jwtUtil,
 * userDetailsService)); //
